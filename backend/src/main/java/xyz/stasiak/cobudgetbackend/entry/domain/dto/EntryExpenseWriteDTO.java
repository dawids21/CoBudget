...
public record EntryExpenseWriteDTO(@CheckDateFormat(pattern = "uuuu-MM-dd", message = "date is invalid") String date,
                                   ...
                                   @NotBlank(message = "subcategory is mandatory") String subcategory,
